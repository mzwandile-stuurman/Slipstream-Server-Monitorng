...
$connectionString = "Server=34.250.17.80;Database=server_monitoring;Integrated Security=True;"
...
"@
    ...
    # ... after all system and process inserts ...
    $insertCount++
